...
export interface FlyCutCaptionLocale {
  ...
  components: {
    ...
    workstation?: {
      ...
      primarySubtitleTab: string;
      secondarySubtitleTab: string;
      bottomOffsetLocked: string;
      useSampleVideo: string;
      loadingSampleVideo: string;
      loadingMedia: string;
      exportingSubtitles: string;
      exportContent: string;
      exportBilingual: string;
      exportMain: string;
      exportSecond: string;
      webavBilingualHint: string;
      exportVideo: string;
      ...
      editModeProcessed: string;
      markMode: string;
      deleteMode: string;
      markHint: string;
      deleteHint: string;
      markHintWordLevel: string;
      deleteHintWordLevel: string;
      originalWordLevelRequired: string;
      originalWordLevelHint: string;
      originalSelectHint: string;
      blankTag: string;
      originalConfirmDone: string;
      originalNoChanges: string;
      confirmSelection: string;
      confirmDeletion: string;
      selectAllOriginal: string;
      clearMarks: string;
      markedCount: string;
      splitMerge: string;
